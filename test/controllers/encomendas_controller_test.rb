...
class EncomendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create encomenda" do
    assert_difference('Encomenda.count') do
      post encomendas_url, params: { encomenda: { email: @encomenda.email, nome: @encomenda.nome, rastreio: @encomenda.rastreio } }
    end
  ...
  test "should update encomenda" do
    patch encomenda_url(@encomenda), params: { encomenda: { email: @encomenda.email, nome: @encomenda.nome, rastreio: @encomenda.rastreio } }
